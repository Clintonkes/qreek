...
async def _ensure_ledger_columns(conn):
    ...
    statements = [
        ...
        "ALTER TABLE transactions ADD COLUMN IF NOT EXISTS family_id VARCHAR",
        "CREATE INDEX IF NOT EXISTS ix_transactions_family_id ON transactions (family_id)",
        "ALTER TABLE transactions ADD COLUMN IF NOT EXISTS source_pool_id VARCHAR",
        ...
        "ALTER TABLE payment_links ADD COLUMN IF NOT EXISTS family_id VARCHAR",
        "CREATE INDEX IF NOT EXISTS ix_payment_links_family_id ON payment_links (family_id)",
        ...
        "ALTER TABLE payroll_entries ADD COLUMN IF NOT EXISTS payout_status VARCHAR",
        "ALTER TABLE payroll_entries ADD COLUMN IF NOT EXISTS payout_reference VARCHAR",
        "ALTER TABLE payroll_entries ADD COLUMN IF NOT EXISTS payout_error TEXT",
        ...
        "ALTER TABLE employees ADD COLUMN IF NOT EXISTS edit_token VARCHAR",
        "CREATE UNIQUE INDEX IF NOT EXISTS ux_employees_edit_token ON employees (edit_token) WHERE edit_token IS NOT NULL",
        "ALTER TABLE employees ALTER COLUMN name DROP NOT NULL",
        "ALTER TABLE employees ALTER COLUMN bank_account DROP NOT NULL",
        "ALTER TABLE employees ALTER COLUMN bank_code DROP NOT NULL",
        "ALTER TABLE employees ALTER COLUMN bank_name DROP NOT NULL",
        "ALTER TABLE employees ALTER COLUMN salary DROP NOT NULL",
        "ALTER TABLE companies ADD COLUMN IF NOT EXISTS invite_token VARCHAR",
